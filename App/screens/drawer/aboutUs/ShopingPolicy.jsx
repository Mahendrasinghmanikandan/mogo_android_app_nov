...
import {Policy, spoping, Terms} from '../../mogoscreen/helper/policy_helper';

const ShopingPolicy = ({navigation}) => {
  ...
  return (
    <>
      <HomeSafeAreaView />
      <StatusBarComponents />
      <HomeArrowView onPress={backPress} title={'Shoping'} />
      <ScrollView>
        <View
          style={[
