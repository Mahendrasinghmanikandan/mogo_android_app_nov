...
import {Cancel, Policy, Terms} from '../../mogoscreen/helper/policy_helper';

const CancelPolicy = ({navigation}) => {
  ...
  return (
    <>
      <HomeSafeAreaView />
      <StatusBarComponents />
      <HomeArrowView onPress={backPress} title={'Order Cancellation Policy'} />
      <ScrollView>
        <View
          style={[
