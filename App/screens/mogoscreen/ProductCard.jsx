...
import {CartStatus} from './helper/priceHelper';
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        <View
          style={{
            ...
            flexDirection: 'row',
            gap: 10,
            paddingHorizontal: customHorizontalpadding ? 10 : 20,
          }}>
              ...
              <TouchableOpacity
                ...
                <TouchableOpacity style={[styles.productImgView]}>
                  <Image
                    ...
                    style={{
                      width: responsive.widthPixel(125),
                      height: 100,
                      borderRadius: 6,
                    }}
                    resizeMethod="scale"
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        handleAddtoFavorite(
                          ...
                          _.get(
                            res,
                            'product_variants[0].varient_unique_id',
                            '',
                          ),
                        );
                      }}>
...
// <View
//   style={[styles.progressLine, {backgroundColor: activeColors.BORDER_COLOR}]}>
